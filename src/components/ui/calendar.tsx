...
function Calendar({
  ...
  return (
    <DayPicker
      className={cn("max-w-full p-3", className)}
      classNames={{
        ...
        weekdays: "flex",
        weekday: "w-11 font-label text-[var(--color-text-muted)]",
        week: "mt-1 flex w-full",
        day: "p-0 text-center",
        day_button:
          "flex size-11 items-center justify-center rounded-full font-small text-[var(--color-text-light)] outline-none transition-colors hover:bg-[var(--color-accent)]/12",
        selected:
